    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sticky-top">
                <button type="button" id="sidebarCollapseI" class="navbar-btnI float-right" style="position: absolute;right: 5px;">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
        ...
        <div id="content">
            ...
            <nav class="navbar sticky-top navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <button id="collapseMenu" class="btn btn-dark d-inline-block d-lg-none ml-auto" type="button" data-toggle="collapse"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" class="form-inline" style="cursor: pointer;" onclick="event.preventDefault();
